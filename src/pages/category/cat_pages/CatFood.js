...
const CatFood = () => {
  ...
  return (
    <>
    <Meta title={"Коти"} />
    <BreadCrumb title=" Корм для котів" />
            ...
            <div className="row">
              <div className="col-3">
                <div className="filter-card rounded-top-3">
                  ...
                  <div className="filter-card">
                      <h3 className="filter-title">Вік кота</h3>
                    <div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для кошенят</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для дорослих котів</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для котів похилого віку</label>
                      </div>
                    </div>
                  </div>
                  <div className="filter-card">
