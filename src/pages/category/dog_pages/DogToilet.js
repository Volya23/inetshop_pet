...
const DogToilet = () => {
  ...
  return (
    <>
    <Meta title={"Собаки"} />
    <BreadCrumb title=" Гігієна будинку для собак" />
                  ...
                  <div className="filter-card">
                    ...
                    <div>
                      <div className="form-check">
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Лоткі і піддони</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Пакети для прибирання</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Совки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Контейнери для пакетів</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Пелюшки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Підгузники</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Привчателі</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Відлякувачі</label>
                      </div>
                    </div>
                  </div>
                  <div className="filter-card">
