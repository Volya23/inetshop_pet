                  ...
                  <div className="filter-card">
                    ...
                    <div>
                      <div className="form-check">
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Переноски</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Автоаксесуари</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Сходинки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Дверцята</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Клітки та вольєри</label>
                      </div>
                    </div>
                  </div>
                  <div className="filter-card">
