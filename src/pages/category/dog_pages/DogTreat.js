...
const DogTreat = () => {
  ...
  return (
    <>
    <Meta title={"Собаки"} />
    <BreadCrumb title=" Ласощі для собак" />
              ...
              <div className="col-3">
                <div className="filter-card rounded-top-3">
                  ...
                  <div className="filter-card">
                      <h3 className="filter-title">Вид ласощів</h3>
                    <div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Снеки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Печево</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Пасти</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Кістки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Топінгі</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Роги</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Натуральні сушеності</label>
                      </div>
                    </div>
                  </div>
                  <div className="filter-card">
                  ...
                  <div className="filter-card">
                    ...
                    <div>
                      <div className="form-check">
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для зубів і ясен</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для суглобів і звʼязок</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для імунітету</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для дресирування</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для зняття стресу</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для поліпшення травлення</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                      ...
                      <div className="form-check">
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для збагачення вітамінами</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Для зору</label>
                      </div>
                    </div>
                  </div>
                  <div className="filter-card">
