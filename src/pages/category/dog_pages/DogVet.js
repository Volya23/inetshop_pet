...
const DogVet = () => {
  ...
  return (
    <>
    <Meta title={"Собаки"} />
    <BreadCrumb title=" Ветпрепарати для собак" />
          ...
          <div className="container-xxl">
            <div className="row">
              ...
              <div className="filter-card rounded-top-3">
                      <h3 className="filter-title">Категорія</h3>
                    <div>
                      <div className="form-check">
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Вітаміни та добавки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Протипаразитарні засоби</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Дерматологічні препарати</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Препарати для очей та вух</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Препарати для суглобів</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Гастроентерологічні препарати</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Серцево-судинні препарати</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Урологічні препарати</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Стоматологічні засоби</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Антибіотики</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Ветеринарні аксесуари</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="filter-card">
                    ...
                    <div>
                      <div className="form-check">
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Пігулки</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
                        ...
                        id=""
                        />
                        <label className="form-check-label" htmlFor="">Краплі</label>
                      </div>
                      <div className="form-check">
                        <input
                        className="form-check-input"
